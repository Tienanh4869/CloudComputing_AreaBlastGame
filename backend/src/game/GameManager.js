...
// EvoWars.io style: Wide open arena with no obstacles or bushes
function generateProceduralTerrain(width = 3000, height = 3000) {
  // No obstacles, no bushes — pure open arena combat
...
const GameManager = {
  ...
  async getOrCreate(rawRoomId, roomCode) {
    ...
    const creationPromise = (async () => {
      ...
      let mapConfig = { width: 3000, height: 3000, url: mapUrl, theme: null };
      ...
      try {
        ...
        if (data) {
          ...
          // Only take theme/styling from remote map JSON; keep our 3000x3000 arena size
